...
$paymentInstruction = buildPaymentInstructionText($settings, $lang, $invoice['tenant_type'] ?? 'monthly');
?>
<!DOCTYPE html>
    ...
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tfoot>
                ...
                <tr class="table-primary">
                    ...
                    <td class="text-end"><strong><?php echo formatCurrency($grandTotal + $totalOutstanding); ?></strong></td>
                </tr>
                <?php endif; ?>
            </tfoot>
        </table>
        ...
        <div class="row align-items-stretch mb-4 qr-code-grid">
            <div class="col-4 text-center">
                <?php echo buildPaymentQRBlockHtml($settings, $grandTotal); ?>
            </div>
            <div class="col-4 text-center">
                <?php
